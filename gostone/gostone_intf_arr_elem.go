...
func Proc8(Array1Par []interface{}, Array2Par [][51]interface{}, IntParI1 int32, IntParI2 int32) {
    var IntLoc int32
    IntLoc = IntParI1 + 5
    ...
    Array2Par[IntLoc][IntLoc - 1] = Array2Par[IntLoc][IntLoc - 1].(int32) + 1
...
func main() {
    ...
    Char2Glob = 0
    for i := 0; i < 51; i ++ {
        Array1Glob[i] = int32(0)
        for j := 0; j < 51; j ++ {
            Array2Glob[i][j] = int32(0)
        }
    }
    PtrGlb = nil
    PtrGlbNext = nil
